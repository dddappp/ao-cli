...
if [ "$HAS_RECEIVER_OUTPUT" = "true" ]; then
    ...
    echo "   🔒 但通过 eval --trace 可以查看目标进程的Handler执行活动"
fi

echo ""
echo "🧪 演示 eval --trace 选项的行为"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "💡 功能说明：eval --trace 显示目标进程的Handler执行活动"
echo "   📋 显示目标进程最近的Handler执行记录和print输出"
echo "   🔍 查询目标进程的结果历史，展示Handler活动"
echo "   ⚠️ 由于进程隔离，无法精确关联每个消息的处理结果"
echo "   ✅ 适用于任何有print输出的Handler，便于调试和监控"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
echo "🎯 新增功能总结："
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "✅ eval --trace: 显示目标进程的Handler执行活动"
echo "✅ 非JSON模式: 直接显示trace信息，方便人类阅读"
echo "✅ JSON模式: trace结果整合到JSON结构的trace字段中"
echo "✅ 通用性: 适用于任何有print输出的Handler，不依赖特定格式"
echo ""
echo "💡 使用场景:"
echo "   - 监控进程Handler执行状态"
echo "   - 调试Handler逻辑和输出"
echo "   - 自动化测试中验证Handler行为"
echo "   - CI/CD流水线中的进程活动监控"
