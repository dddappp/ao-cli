...
if [ "$HAS_RECEIVER_OUTPUT" = "true" ]; then
    ...
    echo "   🔒 但通过 eval --trace 可以精确关联并查看目标进程Handler的执行结果"
fi

echo ""
echo "🧪 演示 eval --trace 选项的行为"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "💡 功能说明：eval --trace 通过Reference精确关联消息处理结果"
echo "   📋 尝试通过消息Reference精确匹配对应的Handler执行结果"
echo "   🔍 如果找到精确匹配，显示该消息触发的handler print输出"
echo "   🔄 如果无法精确关联，则显示最近的handler活动作为参考"
echo "   ✅ 通过AO链上API实现跨进程调试，突破进程隔离限制"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
echo "🎯 新增功能总结："
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "✅ eval --trace: 通过Reference精确关联消息处理结果"
echo "✅ 非JSON模式: 直接显示trace信息，方便人类阅读"
echo "✅ JSON模式: trace结果整合到JSON结构的trace字段中"
echo "✅ 精确性: 通过AO消息系统的Reference机制实现精确关联"
echo ""
echo "💡 使用场景:"
echo "   - 跟踪特定消息的处理结果"
echo "   - 调试跨进程消息传递"
echo "   - 监控Handler执行状态和输出"
echo "   - 自动化测试中验证消息处理"
