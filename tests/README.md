...
table.insert(ao.authorities, "sender_address")
```
...
ao-cli eval "$PROCESS_ID" --data "if not ao.authorities then ao.authorities = {} end; table.insert(ao.authorities, 'sender_address'); return 'Configured'" --wait
